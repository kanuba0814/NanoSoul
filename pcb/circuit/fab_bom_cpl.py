...
IC = {
    ...
    "U5": ("TB6612FNG", "C141517"), "U6": ("QMI8658A", "C3021082"),  # C 版 C2842151 JLC 停产/邮寄→同族 A 版(脚位/驱动同,现货 39k)
    "Q1": ("FS8205A", "C908265"),
...
LCSC_BY_REF = {
    ...
    "R9": "C375525",    # 50mΩ shunt = Yageo RL1206FR-070R05L(1206/1%/250mW/AEC-Q200,JLC 现货 15k)。0805 50mΩ JLC 无现货→改 1206
}
...
LCSC_BY_VALUE = {
    ...
    "0.05": "C375525",  # 50mΩ shunt(1206 现货)；ref R9 已在 LCSC_BY_REF 指定，此为按值兜底
}
# 网表无值的件给个 Comment
COMMENT_OVERRIDE = {
